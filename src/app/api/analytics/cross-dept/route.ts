...
export async function GET(req: NextRequest) {
  ...
  // 1. Docs owned by this dept
  // 2. Other depts' docs viewed by users in this dept
  const matrix: any[] = []
  ...
  for (const dept of depts) {
    ...
    // Views from this dept's users on other depts' docs
    ...
    // Docs owned by this dept, viewed by other depts
