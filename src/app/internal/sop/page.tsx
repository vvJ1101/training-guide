...
export default function SOPPage() {
  ...
  if (loading) {
    return <div className="p-10"><div className="flex items-center gap-2">{[0,150,300].map(d => <span key={d} className="w-2 h-2 rounded-full bg-neutral-300 animate-pulse" style={{ animationDelay: `${d}ms` }} />)}</div></div>
  }

  return (
    <div className="max-w-[900px] mx-auto px-4 md:px-8 py-8 md:py-12">
      <div className="mb-8">
        <h1 className="text-[1.5rem] font-semibold tracking-[-0.02em] text-neutral-900 mb-1">📋 SOP 流程库</h1>
